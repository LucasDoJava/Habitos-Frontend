...
interface HabitCardProps {
  habit: Habit
  onComplete: (id: number, notes?: string) => Promise<boolean>
...
export default function HabitCard({ 
  ...
  const difficulty = DIFFICULTY_SETTINGS[habit.difficulty]
  const progressPercentage = habit.bestStreak > 0 ? (habit.streak / habit.bestStreak) * 100 : 0
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center space-x-1 mb-1">
            ...
            <span className="text-2xl font-bold text-gray-900">{habit.bestStreak}</span>
          </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center space-x-1 mb-1">
            ...
            <span className="text-2xl font-bold text-gray-900">{habit.totalCompletions}</span>
          </div>
      ...
      <div className="flex items-center justify-between mb-4">
        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${difficulty.color} bg-current bg-opacity-10`}>
          {difficulty.name}
        </span>
        <span className="text-sm font-semibold text-gray-700">
          +{difficulty.points} pontos
        </span>
      </div>
